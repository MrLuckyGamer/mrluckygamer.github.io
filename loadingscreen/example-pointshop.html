...
if ( isset($_GET['steamid']) ) {
	...
	$steamid = convertSteamID($steamid64);

	// Request player info from Steam
	$playerinfo = getPlayerSummary($steamid64);
	...
	// Query MySQL database for pointshop details
	require 'pointshop.php';
}
?>
<!DOCTYPE html>
<html>
<head>
	...
	<link rel="stylesheet" type="text/css" href="example-pointshop.css" />
				...
				<div class="board">
					...
					<div class="content">
							...
							<p class="boardinfo">
								...
								<span id="server-name"><?php echo $steamid; ?></span>
							</p>
