<?php
    ...
    $apikey = '72EC5E6F2A47B6275D4B32091CF064AA';
		...
		<div class="row">
			...
			<div class="col-sm-8">
				<div class="well" id="wellbg" style="padding-top: 0; padding-left: 0; padding-right: 0">
					<div>
						<h4 class="text-left" style="color:#fff; background: rgba(0, 0, 0, 0.5); padding: 16px 20px; margin: 0">TIPS</h4>
    ...
    <script>
        $(function() {
            ...
            setInterval(function () {
                var currentImage = $('.cover > img:visible');
                
                currentImage.fadeOut(3000, function() {
                    if($('.cover img:last-child').is(currentImage)) {
                        $('.cover img:first-child').fadeIn(3000)
                    } else {
                        currentImage.next('img').fadeIn(3000)
                    }
                })
            }, 16000);
        });
